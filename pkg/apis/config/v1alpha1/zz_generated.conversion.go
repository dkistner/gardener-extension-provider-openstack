...
func RegisterConversions(s *runtime.Scheme) error {
	if err := s.AddGeneratedConversionFunc((*ApplicationCrendentialConfig)(nil), (*config.ApplicationCrendentialConfig)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_v1alpha1_ApplicationCrendentialConfig_To_config_ApplicationCrendentialConfig(a.(*ApplicationCrendentialConfig), b.(*config.ApplicationCrendentialConfig), scope)
	}); err != nil {
		return err
	}
	if err := s.AddGeneratedConversionFunc((*config.ApplicationCrendentialConfig)(nil), (*ApplicationCrendentialConfig)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_config_ApplicationCrendentialConfig_To_v1alpha1_ApplicationCrendentialConfig(a.(*config.ApplicationCrendentialConfig), b.(*ApplicationCrendentialConfig), scope)
	}); err != nil {
		return err
	}
...
// Convert_v1alpha1_ApplicationCrendentialConfig_To_config_ApplicationCrendentialConfig is an autogenerated conversion function.
func Convert_v1alpha1_ApplicationCrendentialConfig_To_config_ApplicationCrendentialConfig(in *ApplicationCrendentialConfig, out *config.ApplicationCrendentialConfig, s conversion.Scope) error {
	return autoConvert_v1alpha1_ApplicationCrendentialConfig_To_config_ApplicationCrendentialConfig(in, out, s)
}
...
// Convert_config_ApplicationCrendentialConfig_To_v1alpha1_ApplicationCrendentialConfig is an autogenerated conversion function.
func Convert_config_ApplicationCrendentialConfig_To_v1alpha1_ApplicationCrendentialConfig(in *config.ApplicationCrendentialConfig, out *ApplicationCrendentialConfig, s conversion.Scope) error {
	return autoConvert_config_ApplicationCrendentialConfig_To_v1alpha1_ApplicationCrendentialConfig(in, out, s)
}
...
func autoConvert_v1alpha1_ControllerConfiguration_To_config_ControllerConfiguration(in *ControllerConfiguration, out *config.ControllerConfiguration, s conversion.Scope) error {
	...
	out.ApplicationCrendentialConfig = (*config.ApplicationCrendentialConfig)(unsafe.Pointer(in.ApplicationCrendentialConfig))
	return nil
}
...
func autoConvert_config_ControllerConfiguration_To_v1alpha1_ControllerConfiguration(in *config.ControllerConfiguration, out *ControllerConfiguration, s conversion.Scope) error {
	...
	out.ApplicationCrendentialConfig = (*ApplicationCrendentialConfig)(unsafe.Pointer(in.ApplicationCrendentialConfig))
	return nil
}
